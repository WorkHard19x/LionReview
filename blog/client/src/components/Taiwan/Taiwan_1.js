...
const { pageId } = useParams(); // Get the pageId from the route parameter
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Taiwan_1_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Taiwan_1_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Taiwan_1-epdisode';
        const userName2 = 'Taiwan_1-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Taiwan_1-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Taiwan_1-image', JSON.stringify(imageData));
                }, [imageData]);
