...
const { pageId } = useParams(); // Get the pageId from the route parameter
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Japan_2_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Japan_2_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Japan_2-epdisode';
        const userName2 = 'Japan_2-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Japan_2-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Japan_2-image', JSON.stringify(imageData));
                }, [imageData]);
