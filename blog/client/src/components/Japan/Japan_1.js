...
const { pageId } = useParams(); // Get the pageId from the route parameter
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Japan_1_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Japan_1_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Japan_1-epdisode';
        const userName2 = 'Japan_1-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Japan_1-image');
                    return storedImageData ? JSON.parse(storedImageData) : [
                        { url: "https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg",
                          title: "Japan_1",
                            img: "https://i.mydramalist.com/k2lrO_4f.jpg" },
                        { url: "",
                          title: "",
                            img: "" },
                        { url: "",
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Japan_1-image', JSON.stringify(imageData));
                }, [imageData]);
