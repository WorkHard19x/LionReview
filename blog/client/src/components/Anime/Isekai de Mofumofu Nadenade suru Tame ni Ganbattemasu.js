                ...
                function IsekaideMofumofuNadenadesuruTameniGanbattemasu() {
    ...
    const uploadDate = new Date('2024-05-17'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu_icons');
            return storedIcons ? JSON.parse(storedIcons) : [
               { url: "https://www.youtube.com/embed/IZQs__biGDY"},
                { url: ""},
                { url: ""},
                { url: ""},
                { url: ""},
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu-epdisode';
        const userName2 = 'Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu-image', JSON.stringify(imageData));
                }, [imageData]);
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> Isekai de Mofumofu Nadenade suru Tame ni Ganbattemasu</span>
            ...
            <div className="summary-main">
                    <div className="summary-nav">
                        <div className="summary-first">
                            <img src="https://cdn.myanimelist.net/images/anime/1925/139564.jpg" alt=""
...
<p>Status: Finished Airing
</p>
<p>Aired: Jan 7, 2024 to Mar 24, 2024
</p>
<p>Premiered: Winter 2024
</p>
<p>Broadcast: Sundays at 22:00 (JST)
</p>
<p>Thank you for watching my video</p>
</p>
                        </div>
                    </div>
            </div>
...
To help her get started, God grants Midori a special ability: to be liked by all kinds of non-humans—whether it be animals or holy beasts—enabling her to embrace and cuddle them as much as she wants. Now reborn as Nefertima Osfe, a duke's daughter, she enjoys her new life to the fullest alongside her adorable companions. However, it will not be long before she discovers what her task truly entails and that her time in this world will not always be fluffy.
        ...
        {isVisible && (
            ...
            export default IsekaideMofumofuNadenadesuruTameniGanbattemasu;
