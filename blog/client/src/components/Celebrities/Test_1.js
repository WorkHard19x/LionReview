                ...
                function Test_1() {
                    ...
                    const [birthdated, setBirthdate] = useState('2024-05-07'); // Set initial birthdate
                
                    const toggleDropdown = () => {
                        setIsDropdownOpen(!isDropdownOpen);
                    };
                    const shareOptions = ['Copy Link', 'Facebook', 'Twitter', 'Messenger'];
                    const shareUrl = '/leo doan';
                    ...
                    function calculateAge() {
                        ...
                        const [name, setName] = useState(localStorage.getItem(window.location.href + '-name') || 'leo doan');
                        ...
                        const userName = 'leo doan-shows'; // Define the userName variable
                        const userNamenews = 'leo doan-news'; // Define the userName variable
                                ...
                                <div className="profile-border">
                                    <div className="profile-content">
                                        ...
                                        <div className="profile-image">
                                            ...
                                            <img src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" alt="leo doan" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
