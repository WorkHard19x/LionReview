                ...
                function Cel_2() {
                    ...
                    function calculateAge() {
                        ...
                        const [name, setName] = useState(localStorage.getItem(window.location.href + '-name') || 'Cel_2');
                        ...
                        const userName = 'Cel_2-shows'; // Define the userName variable
                        const userNamenews = 'Cel_2-news'; // Define the userName variable
                                ...
                                <div className="profile-border">
                                    <div className="profile-content">
                                        ...
                                        <div className="profile-image">
                                            ...
                                            <img src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" alt="Cel_2" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
