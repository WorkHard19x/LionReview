                ...
                function TheMidnightRomanceinHagwon() {
    ...
    const uploadDate = new Date('2023-12-31'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('The Midnight Romance in Hagwon_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('The Midnight Romance in Hagwon_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'The Midnight Romance in Hagwon-epdisode';
        const userName2 = 'The Midnight Romance in Hagwon-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('The Midnight Romance in Hagwon-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('The Midnight Romance in Hagwon-image', JSON.stringify(imageData));
                }, [imageData]);
                ...
                useEffect(() => {
                    ...
                    const handleUpdateTitle = async () => {
                        try {
                            ...
                            const response = await axios.put(`http://localhost:5000/api/kd/${searchResult.id_data}`, {
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> The Midnight Romance in Hagwon</span>
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['romantic', 'costume', 'fantasy', 'action', 'crime', 'thriller', 'animation']</span>
...
<div style={{ margin: '5px' }}>
    {user && user.is_admin &&(
        ...
        {isVisible && (
            ...
            export default TheMidnightRomanceinHagwon;
