    ...
    const uploadDate = new Date('2023-11-27'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Suspicious_Partner_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Suspicious_Partner_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Suspicious_Partner-epdisode';
        const userName2 = 'Suspicious_Partner-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Suspicious_Partner-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Suspicious_Partner-image', JSON.stringify(imageData));
                }, [imageData]);
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> Suspicious_Partner</span>
...
<div style={{ margin: '5px' }}>
    {user && user.is_admin &&(
        ...
        {isVisible && (
            ...
            export default Suspicious_Partner;
