    ...
    const uploadDate = new Date('2024-05-02'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Test_korean10_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Test_korean10_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Test_korean10-epdisode';
        const userName2 = 'Test_korean10-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Test_korean10-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Test_korean10-image', JSON.stringify(imageData));
                }, [imageData]);
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> Test_korean10</span>
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['romantic', 'costume', 'action', 'thriller', 'fantasy']</span>
