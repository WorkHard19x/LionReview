    ...
    const uploadDate = new Date('2023-10-23'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Test_korean_icons');
            return storedIcons ? JSON.parse(storedIcons) : [
                { url: "https://www.youtube.com/embed/akEZ3DuEKRc"},
                { url: "https://www.youtube.com/embed/qKwJmZA3ynw?list=RDqKwJmZA3ynw"},
                { url: ""},
                { url: ""},
                { url: ""},
                { url: ""},
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Test_korean_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Test_korean-epdisode';
        const userName2 = 'Test_korean-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Test_korean-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Test_korean-image', JSON.stringify(imageData));
                }, [imageData]);
                ...
                useEffect(() => {
                    ...
                    const handleEditedDateChange = (e) => {
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> Test_korean</span>
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['romantic', 'costume', 'fantasy', 'crime', 'thriller', 'animation', 'action']</span>
                        ...
                        <div>
                            ...
                            {searchResult && (
                                <div>
                                    ...
                                    <input type="date" value={editedDate} onChange={handleEditedDateChange} />        
