    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Korean_1_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Korean_1_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Korean_1-epdisode';
        const userName2 = 'Korean_1-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Korean_1-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Korean_1-image', JSON.stringify(imageData));
                }, [imageData]);
                ...
                <div className='korean-title'>
                    ...
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['romantic']</span>
                            <span>https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg</span>
