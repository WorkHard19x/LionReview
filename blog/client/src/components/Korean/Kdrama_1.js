    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Kdrama_1_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Kdrama_1_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Kdrama_1-epdisode';
        const userName2 = 'Kdrama_1-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Kdrama_1-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Kdrama_1-image', JSON.stringify(imageData));
                }, [imageData]);
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> Kdrama_1</span>
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['costume', 'romantic', 'action', 'crime', 'thriller', 'animation']</span>
