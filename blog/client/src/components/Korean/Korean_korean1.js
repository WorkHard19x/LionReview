    ...
    const uploadDate = new Date('2024-03-24'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Korean_korean1_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Korean_korean1_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Korean_korean1-epdisode';
        const userName2 = 'Korean_korean1-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Korean_korean1-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Korean_korean1-image', JSON.stringify(imageData));
                }, [imageData]);
        ...
        <div className="profile-containerd">
            <div className="profile-containerd-korean">
                <div className='korean-title'>
                    <i className="fa-solid fa-film"> </i> <span> Korean_korean1</span>
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['romantic', 'costume', 'action', 'crime', 'thriller', 'animation', 'fantasy']</span>
