    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Costume Period_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Costume Period_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Costume Period-epdisode';
        const userName2 = 'Costume Period-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Costume Period-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Costume Period-image', JSON.stringify(imageData));
                }, [imageData]);
                ...
                <div className='korean-title'>
                    ...
                    <div className="border-test">
                        <p>
                            <span></span>
                            <span>['costume']</span>
                            <span>https://t3.ftcdn.net/jpg/06/48/50/58/360_F_648505884_bxioT9qrfODG4SbRZgHvBOLGesjsIa1j.jpg</span>
