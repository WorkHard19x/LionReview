...
const { pageId } = useParams(); // Get the pageId from the route parameter
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Thailand_2_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Thailand_2_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Thailand_2-epdisode';
        const userName2 = 'Thailand_2-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Thailand_2-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Thailand_2-image', JSON.stringify(imageData));
                }, [imageData]);
