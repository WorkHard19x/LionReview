    ...
    const uploadDate = new Date('2024-05-04'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Chinese_1_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Chinese_1_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Chinese_1-epdisode';
        const userName2 = 'Chinese_1-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Chinese_1-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Chinese_1-image', JSON.stringify(imageData));
                }, [imageData]);
