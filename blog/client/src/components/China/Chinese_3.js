    ...
    const uploadDate = new Date('2024-05-10'); // '2024-04-02' represents April 2, 2024
    ...
    const daysDifference = Math.floor(timeDifference / (1000 * 3600 * 24));
        ...
        const checkIfUserIsAdmin = () => {
            ...
            const storedIcons = localStorage.getItem('Chinese_3_icons');
    ...
    useEffect(() => {
        ...
        localStorage.setItem('Chinese_3_icons', JSON.stringify(icons));
    }, [icons]);
    ...
    const saveToMongoDB = async (icons, pageId) => {
        ...
        const userName = 'Chinese_3-epdisode';
        const userName2 = 'Chinese_3-image';
    ...
    const handleClose = () => {
        ...
        setTimeout(() => {
          setIsVisible(true);
                    ...
                    const storedImageData = localStorage.getItem('Chinese_3-image');
                ...
                useEffect(() => {
                    // Save icons state to localStorage whenever it changes
                    localStorage.setItem('Chinese_3-image', JSON.stringify(imageData));
                }, [imageData]);
